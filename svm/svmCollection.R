...
# Book:       	MVA
# ------------------------------------------------------------------------------
# Quantlet:   	MVASVMorangepeel
# ------------------------------------------------------------------------------
# Description:	MVASVMorangepeel plots the area of two different groups via svm 
#				classification using anipotropic Gaussian kernel
# ------------------------------------------------------------------------------
# See also:     MVA3svm02, MVAppsib, ppsib, ppsibexample
# ------------------------------------------------------------------------------
# Keywords:     Gaussian, SVM, anitropic, kernel
# ------------------------------------------------------------------------------
# Usage:      	-
# ------------------------------------------------------------------------------
# Inputs:     	None
# ------------------------------------------------------------------------------
# Output:     	2-DIm Plot of a svm classification for orangepeel data using
#               anisotropic Gaussian kernel.
# ------------------------------------------------------------------------------
# Example:      Change value of r in anisotropic gaussian kernel for different
#               parameter values.
# ------------------------------------------------------------------------------
# Author:     	Wolfgang H?rdle, Dedy Dwi Prastyo, 20110707
# ------------------------------------------------------------------------------

# Generate "orange peel" data
# n(-1)=n(+1)=100, n=200
# x(-1) normally multivariate distributed N(mu=(0,0), sigma=diag(1/4, 1/4) diagonal matrix
...
# install required packages, if you are not connected to internet, please install the packages manually
...
# define anisotropic gaussian kernel function
